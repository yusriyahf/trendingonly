    ...
    <div class="container-xl">
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <a href="<?php echo base_url() . "penulis/meta/tambah" ?>" class="btn btn-primary me-md-2"> + Tambah Meta</a>
            </div>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td valign="middle">
                                                <div class="d-grid gap-2">
                                                    <!--<a href="<?= base_url('penulis/meta/delete') . '/' . $tampilMeta['id_meta'] ?>" class="btn btn-danger">Hapus</a>-->
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal<?= $tampilMeta['id_meta'] ?>">
                                                        Hapus
                                                    </button>
                                                    <a href="<?= base_url('penulis/meta/edit') . '/' . $tampilMeta['id_meta'] ?>" class="btn btn-primary">Ubah</a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?= base_url('penulis/meta/delete') . '/' . $meta['id_meta'] ?>" class="btn btn-danger">Hapus</a>
                </div>
            </div>
        </div>
    </div>
