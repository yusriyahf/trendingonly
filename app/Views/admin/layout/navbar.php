<div id="app-sidepanel" class="app-sidepanel">
    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding">
            <a class="app-logo" href="<?= base_url('admin/dashboard') ?>"><img class="logo-icon me-2" src="<?= base_url('Trending Only.png') ?>" style="width: auto;" alt="logo"></a>
        </div><!--//app-branding-->
        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= (current_url() == base_url('admin/kontak') ? 'active' : '') ?>" href="<?= base_url('admin/kontak') ?>">
                        <span class="nav-icon">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= (current_url() == base_url('admin/penuis/index') ? 'active' : '') ?>" href="<?= base_url('admin/penulis/index') ?>">
                        <span class="nav-icon">
