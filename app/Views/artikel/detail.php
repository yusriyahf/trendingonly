                ...
                <div class="col-md-8">
                    ...
                    <div class="section-row">
                        <?php if (!empty($artikel['gambar_besar'])): ?>
                            <div class="featured-image-container" style="width: 100%; margin: 0 auto 20px; font-size: 20px;">
                                ...
                                <div style="text-align: left; color: #666; margin-top: 8px; font-size: 14px; line-height: 1.4;">
                                    <?= service('request')->getLocale() == 'en' ? 'Source:' : 'Sumber:' ?>
                                    <span style="color: #333; font-weight: 500;">
                                        <?= !empty(trim($artikel['sumber_gambar'])) ? esc($artikel['sumber_gambar']) : (service('request')->getLocale() == 'en' ? 'Not specified' : 'Tidak disebutkan') ?>
                                    </span>
                                </div>
                            </div>
                        <?php else: ?>
